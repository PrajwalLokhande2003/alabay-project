    ...
    return (
        <>
            <div className="roadMap">
                <div className="hRoad">ROAD MAP</div>
                <div className="imgDiv">
                    <img alt="img1" src="https://s3-alpha-sig.figma.com/img/8af3/96f7/cd09a6d1e8a5d28e3a24eba452812d8b?Expires=1729468800&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=fjKSV4uCQou3FGFxsFLF7kje-YRwUzpEa8T8E6GesiY9BMm8TTTfE~8wAGfsPkbYJSDeOpOoc89lpGsjGlPlQAU7BSxDMuIkFPwU8QDFSOpEqPG4f5LEItiLCzun9Op7AuDyz5~X~QuvjMD363KIwd3KOYMtX8YEI9ul0NHc~viKeQDz2TJJbxjnbgf4~O~VbhaRGIvaWel2M3bgdF6-dyaIhcbbhbQ~endNfyxiZO1kGoUGeQ0HUuFvHFS-8rL9BuHkVeRAFc1okw80Xgh1sMtWaWANnxACPVJFPrbkcH0KcuDsMuaTAHvs5qWI8G2kBzNDbthXgTN3icMlt1Z7CA__" className="img1" />
